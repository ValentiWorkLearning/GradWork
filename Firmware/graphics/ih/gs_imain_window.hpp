...
public:
    ...
    virtual void addPage(std::unique_ptr<Graphics::Views::IPageViewObject>&& _toAdd) noexcept = 0;
    ...
    virtual const Graphics::Views::IPageViewObject& getPage(
        std::string_view _pageName) const noexcept = 0;
