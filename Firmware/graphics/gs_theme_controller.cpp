...
lv_color_t ThemeController::getMainThemeColor(Color _fromColor) const noexcept
{
    switch (_fromColor)
    {
...
ThemeController::ThemeController(
    ...
    std::uint32_t _displayHeight) noexcept
...
void ThemeController::setActiveTheme(ColorTheme _themeToSet) noexcept
{
...
lv_style_t ThemeController::getIconsFont(FontSize _fontStyle, Color _fontColor) const noexcept
{
...
lv_style_t ThemeController::getFontStyle(FontSize _fontStyle, Color _fontColor) const noexcept
{
...
std::unique_ptr<IThemeController> createThemeController(
    ...
    std::uint32_t _displayHeight) noexcept
{
    return std::make_unique<ThemeController>(_initialColorTheme, _displayWidth, _displayHeight);
}
