...
WidgetBaseObj<TBaseWidgetInterface>::WidgetBaseObj(
    ...
    : m_isWidgetVisible{false}, m_pThemeController{_themeController}
{
}

template <typename TBaseWidgetInterface> void WidgetBaseObj<TBaseWidgetInterface>::show() noexcept
{
    m_isWidgetVisible = true;
}

template <typename TBaseWidgetInterface> void WidgetBaseObj<TBaseWidgetInterface>::hide() noexcept
{
    m_isWidgetVisible = false;
}

template <typename TBaseWidgetInterface>
bool WidgetBaseObj<TBaseWidgetInterface>::isVisible() const noexcept
{
    return m_isWidgetVisible;
}

template <typename TBaseWidgetInterface>
typename WidgetBaseObj<TBaseWidgetInterface>::ShowParams WidgetBaseObj<
    TBaseWidgetInterface>::getShowParams() noexcept
{
    ...
    return WidgetBaseObj<TBaseWidgetInterface>::ShowParams{
        parent, pThemeProvider->getDisplayWidth(), pThemeProvider->getDisplayHeight()};
}

template <typename TBaseWidgetInterface>
const Theme::IThemeController* WidgetBaseObj<TBaseWidgetInterface>::getThemeController()
    const noexcept
{
