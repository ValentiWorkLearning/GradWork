...
macro(nRF5x_setup)
    ...
    elseif (NRF_TARGET MATCHES "nrf52")
        ...
        add_definitions(-DSOFTDEVICE_PRESENT -DS112 -DSWI_DISABLE0 -DBLE_STACK_SUPPORT_REQD -DNRF_SD_BLE_API_VERSION=6 -DENABLE_SWO )
        include_directories(
        ...
        set(SOFTDEVICE_PATH "${NRF5_SDK_PATH}/components/softdevice/s112/hex/s112_nrf52_7.0.1_softdevice.hex")
    endif ()
    ...
    set(CMAKE_EXE_LINKER_FLAGS "-mthumb -mabi=aapcs -std=gnu++17 -std=c99 -L ${NRF5_SDK_PATH}/modules/nrfx/mdk -T${NRF5_LINKER_SCRIPT} ${CPU_FLAGS} -Wl,--gc-sections --specs=nano.specs -lc -lnosys -lm")
