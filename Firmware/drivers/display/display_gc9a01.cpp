...
GC9A01::initDisplay()
{
    ...
    sendCommand(0x85,0xFF);
    sendCommand(0x86,0xFF);
    sendCommand(0x87,0xFF);
    sendCommand(0x88,0x0A);
    sendCommand(0x89,0x21);
    sendCommand(0x8A,0x00);
    sendCommand(0x8B,0x80);
    sendCommand(0x8C,0x01);
    sendCommand(0x8D,0x01);
    sendCommand(0x8E,0xFF);
    sendCommand(0x8F,0xFF);

    sendCommand(0xB6,0x00,0x00);

    if constexpr( HorizontalOrientation::CurrentChoise == HorizontalOrientation::THorizontal::kUseHorizontalOne )
        sendCommand(0x36,0x18);
    else if constexpr( HorizontalOrientation::CurrentChoise == HorizontalOrientation::THorizontal::kUseHorizontalTwo )
        sendCommand(0x36,0x28);
    else if constexpr( HorizontalOrientation::CurrentChoise == HorizontalOrientation::THorizontal::kUseHorizontalThree )
        sendCommand(0x36,0x48);
    else
        sendCommand(0x36,0x88);
    ...
    sendCommand(0xC3,0x13);
    sendCommand(0xC4,0x13);

    sendCommand(0xC9,0x22);
    ...
    sendCommand(0xAE,0x77);

    sendCommand(0xCD,0x63);

    sendCommand(0x70,0x07,0x07,0x04,0x0E,0x0F,0x09,0x07,0x08,0x03);
